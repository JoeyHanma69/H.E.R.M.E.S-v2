...
class WhisperSTT:
    ...
    def __init__(self, model_name: str = "base", language: str | None = None):
        ...
        try:
            ...
            _offline_keywords = (  
                    "offline", "not found", "cacher", "localentry",  
                    "does not exist", "outgoing" "lcoal_files_only"
                ) 
            if any(k in _e for k in _offline_keywords): 
                ...
                os.environ.pop("TRANSFORMER_OFFLINE", None) 
    ...
    def transcribe(self, audio: np.ndarray) -> str: 
        """Transcribe a float32 mono 16 kHz numpy array. Reutrns transcript string.""" 
        try: 
...
class VoskSTT: 
    ...
    def __init__(self, model_path:str | None = None, language: str = "en-us"): 
        ...
        if model_path: 
            ...
            lang = language.strip().lower() if language and language.strip().lower() != "auto" else language
